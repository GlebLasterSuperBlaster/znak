...
<main>
    <article class="container art-serv text-indent">
        ...
        <p>Принимая данные Условия вы также соглашаетесь с нашей <a href="privacy-policy">Политикой конфиденциальности</a> и <a href="content-policy">Правилами размещения контента</a>. </p>
        ...
        <ul>
            ...
            <li>На один номер своего мобильного телефона создавать не более одного аккаунта. При наличии у вас дополнительных номеров мобильных телефонов, вы можете указать их в своем профиле. Подробнее в разделе «<a href="faq#h_3">Зачем указывать в профиле второй номер телефона</a>».</li>
        ...
        <p>Мы хотим, чтобы сервис ПоЗнакомым эффективно и безопасно выполнял свою <a href="detail#h_1">миссию</a>, не нанося вред благополучию других людей и не нарушая моральных принципов нашего сообщества. В связи с этим вы соглашаетесь воздерживаться от действий, описанных ниже (не способствовать таким действиям и не поддерживать такие действия со стороны других людей):</p>
        <ul>
            <li>Вы не имеете права нарушать <a href="content-policy">Правила размещения контента</a> при размещении любого контента в сервисе ПоЗнакомым.</li>
        ...
        <ul>
            <li><u>Адресная книга</u>. Вы регулярно предоставляете нам доступ к телефонным номерам, хранящимся в адресной книге вашего мобильного телефона, которые используются сервисом исключительно для его работы. Телефонные номера из адресной книги шифруются и передаются на наши сервера в обезличенном виде (подробнее см. <a href="privacy-policy">Политика конфиденциальности</a>). Вы подтверждаете, что имеете право предоставлять нам эти номера для обеспечения работы Сервиса.</li>
            <li><u>Связи с другими пользователями</u>. Мы нигде и ни при каких обстоятельствах не показываем полный список пользователей Сервиса, телефоны которых есть в вашей адресной книге. Однако, по отдельности такие связи могут отображаться другим пользователям вашего сообщества в цепочках знакомств, если цепочка до нужного профиля, визитки или запроса, проходит через вас и вашего знакомого. Вы даете разрешение на отображение таких связей в цепочках знакомств. Также вы всегда можете изменить это поведение, исключив малознакомые или нежелательные контакты вашей адресной книги. Подробнее в разделе <a href="detail#h_5">Принципы построения сообщества</a>. </li>
            <li><u>Разрешение на запрос рекомендаций</u>. Используя встроенный чат, пользователи  сервиса могут обращаться к в вам за советом или рекомендациями, и вы предоставляете им такое разрешение.</li>
            <li><u>SMS сообщения</u>. Вы соглашаетесь получать SMS-сообщения с кодом для регистрации в Сервисе. Мы не осуществляем никаких рекламных и прочих SMS рассылок, однако мы можем информировать о пропущенных сообщениях от других пользователей.</li>
			...
			<li><u>Разрешение на отправку вашего контакта</u>, а именно номера телефона и ФИО, пользователю который вас пригласил в сервис, а также пользователям, которых пригласили вы. Это необходимо, чтобы установить связь между вами и пользователем, которого вы приглашаете. Однако, вы всегда можете «Скрыть контакт» в списке контактов в приложении.</li>
        </ul>

        <h2 id="h_5">Дополнительные положения</h2>
        <h3 id="h_6">Сообщения от Сервиса</h3>
        <p>Мы вправе отправлять вам сообщения о нашем Сервисе, функциях, условиях, правилах и других важных новостях. Информировать о пропущенных сообщениях от других пользователей через электронную почту или SMS-сообщения.</p>
