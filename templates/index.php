...
<![endif]-->
<audio id="myAudio">
    <source src="/assets/audio/knob.mp3" type="audio/mpeg">
    <source src="/assets/audio/knob.ogg" type="audio/ogg">
</audio>
        ...
        <div class="container">
            <div class="row-header">
                <div class="col-left">
                    ...
                    <h1 class="h-header"><span>ПоЗнакомым -</span>рекомендательный сервис</h1>
                    <div class="buttons">
                        <a href="<?php print $redirects['iPhone']; ?>" class="btn btn-header">
                        ...
                        <a href="<?php print $redirects['Android']; ?>" class="btn btn-header">
                ...
                <div class="col-right">
                    <img src="/assets/img/phone_top@2x.png" alt="скриншот приложения">
                </div><!-- /.col -->
            </div><!-- /.row-header -->
        </div><!-- /.container -->
    </div><!-- /.header-site_i -->
...
<main class="content-landing">
    <section class="section">
        <div class="container">
            <h2 class="h-section">Рекомендации знакомых и их друзей</h2>
            <div class="row-carousel">
                <div class="slide">
                    <p class="h-slide">Кто посоветует <br> хорошего врача?</p>                    
                    <div class="/assets/img-slide"><img src="/assets/img/1.png" alt="pic"></div>
                </div>
                <div class="slide">
                    <p class="h-slide">Где найти <br> проверенную няню?</p>
                    <div class="/assets/img-slide"><img src="/assets/img/2.png" alt="pic"></div>
                </div>
                <div class="slide">
                    <p class="h-slide">Где взять <br> надёжного мастера?</p>
                    <div class="/assets/img-slide"><img src="/assets/img/3.png" alt="pic"></div>
                </div>
            </div><!-- /.row-carousel -->
            <p class="description">Когда нужен надежный специалист - будь то врач, строитель, садовник, юрист или кто-либо еще.
                    Когда нужен добрый совет, помощь - мы в первую очередь <b>обращаемся к друзьям и знакомым</b>.</p>

			<div class="video-block">
				<div class="video">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/2ZYjiKLbiI4?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
				<p class="description small">Короткое видео о возможностях сервиса - 1,5 мин.</p>
				<p class="description">Мобильное приложение ПоЗнакомым поможет найти проверенного специалиста по рекомендациям друзей и их знакомых до третьего рукопожатия.</p>
			</div>
    ...
    <section class="section bg">
        <div class="container">
            <h2 class="h-section">Правило трех рукопожатий</h2>
            <p class="description">Ключевая особенность сервиса ПоЗнакомым – <b>правило трех рукопожатий</b>. Допустим, у тебя 20 знакомых, мнению которых ты доверяешь. У каждого из знакомых ещё по 20 знакомых. Это уже 400 человек и это только второе рукопожатие! На третьем рукопожатии это будет уже 8000 человек!</p>
            <div id="circular">
    ...
    <section class="section">
        <div class="container">
            <div class="row-carousel">
                <div class="slide">
                    <div class="/assets/img-slide"><img src="/assets/img/4.png" alt="pic"></div>
                    <p class="h-slide h-dash">Ищи</p>
                    <p>Ищи без звонков знакомым и репостов в социальных сетях. Выбирай проверенных по рекомендациям!</p>
                </div> 
                <div class="slide">
                    <div class="/assets/img-slide"><img src="/assets/img/5.png" alt="pic"></div>
                    <p class="h-slide h-dash">Спрашивай</p>
                    <p>Спроси совета у друзей и их знакомых. Знакомые помогут!</p>
                </div> 
                <div class="slide">
                    <div class="/assets/img-slide"><img src="/assets/img/6.png" alt="pic"></div>
                    <p class="h-slide h-dash">Рекомендуй</p>
                    <p>Знаешь хорошего профессионала? Пригласи в сервис и порекомендуй знакомым!</p>
                </div>
            </div><!-- /.row-carousel -->
        </div><!-- /.container -->
    </section>    
    ...
    <section class="section bg">
        <div class="container">
            ...
            <p class="description">Скачай бесплатное приложение ПоЗнакомым в App Store или Google Play. Зарегистрируйся, указав номер мобильного телефона. Предоставь доступ к телефонной книге, чтобы сервис смог найти рекомендации твоих знакомых. Этого достаточно чтобы начать пользоваться сервисом. Приглашать «в друзья» не нужно!</p>
 
            <div class="howitworks">
                <div id="device">
                    <div class="device" data-id="slide-1"><img class="image" src="/assets/img/im_phone_scr_1@2x.png" alt="pic"></div>
                    <div class="device" data-id="slide-2"><img class="image" src="/assets/img/im_phone_scr_2@2x.png" alt="pic"></div>
                    <div class="device" data-id="slide-3"><img class="image" src="/assets/img/im_phone_scr_3@2x.png" alt="pic"></div>
                    <div class="device" data-id="slide-4"><img class="image" src="/assets/img/im_phone_scr_4@2x.png" alt="pic"></div>
                    <div class="device" data-id="slide-5"><img class="image" src="/assets/img/im_phone_scr_5@2x.png" alt="pic"></div>
                    <div class="device" data-id="slide-6"><img class="image" src="/assets/img/im_phone_scr_6@2x.png" alt="pic"></div>
                </div>                
                <div class="row-carousel-2" id="slides">
                    <div class="slide-card" data-id="slide-1">
                        <div class="screenshot"><img class="image" src="/assets/img/im_phone_scr_1@2x.png" alt="pic"></div>
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="h-slide-card">Cообщество знакомых</p>
                            </div>
                            <p>По контактам телефонной книги сервис найдет твоих знакомых уже зарегистрированных в сервисе и создаст персональное сообщество.</p>
                        </div><!-- /.card -->
                    </div><!-- /.slide-card -->
                    <div class="slide-card" data-id="slide-2">
                        <div class="screenshot"><img class="image" src="/assets/img/im_phone_scr_2@2x.png" alt="pic"></div>
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="h-slide-card">Визитки</p>
                            </div>
                            <p>Ищешь новых клиентов? Опубликуй визитку! Делай тематические публикации, собирай отзывы и продвигай свои услуги по сарафанному радио.</p>
                        </div><!-- /.card -->
                    </div><!-- /.slide-card -->
                    <div class="slide-card" data-id="slide-3">
                        <div class="screenshot"><img class="image" src="/assets/img/im_phone_scr_3@2x.png" alt="pic"></div>                        
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="h-slide-card">Достоверные отзывы</p>
                            </div>
                            <p>Отзывы заслуживают доверия. Потому что никто не захочет рекомендовать плохой сервис своим знакомым.</p>
                        </div><!-- /.card -->
                    </div><!-- /.slide-card -->
                    <div class="slide-card" data-id="slide-4">
                        <div class="screenshot"><img class="image" src="/assets/img/im_phone_scr_4@2x.png" alt="pic"></div>                        
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="h-slide-card">Цепочка знакомств</p>
                            </div>
                            <p>Подскажет чей знакомый оставил отзыв или знает нужного тебе специалиста. Запрашивай рекомендации в чате!</p>
                        </div><!-- /.card -->
                    </div><!-- /.slide-card -->
                    <div class="slide-card" data-id="slide-5">
                        <div class="screenshot"><img class="image" src="/assets/img/im_phone_scr_5@2x.png" alt="pic"></div>
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="h-slide-card">Запросы</p>
                            </div>
                    ...
                    <div class="slide-card" data-id="slide-6">
                        <div class="screenshot"><img class="image" src="/assets/img/im_phone_scr_6@2x.png" alt="pic"></div>                        
                        <div class="card">
                            <div class="header">
                            ...
                            <p>Имена контактов из адресной книги остаются твоей тайной и никуда не передаются. Номера телефонов шифруются. <a href="privacy-policy">Подробнее</a></p>
                        </div><!-- /.card -->
                    </div><!-- /.slide-card -->                                                                                                    
                </div><!-- /.row-carousel-2 -->
            </div><!-- /.howitworks -->
    ...
    <section class="section">
        <div class="container">
            <h2 class="h-section">Расскажи знакомым!</h2>
            <p class="description">Каждый знакомый, который зарегистрируется в сервисе, автоматически присоединится к твоему сообществу. Присоединившись к сообществу он дополнит его своими связями и рекомендациями, а в нужный момент поможет советом!</p>
            <p class="description"><b>ПоЗнакомым - полезно тебе, полезно знакомым!</b></p>
            <div class="buttons buttons-center">
                <a href="<?php print $redirects['iPhone']; ?>" class="btn btn-dark">
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M22 17.607c-.786 2.28-3.139 6.317-5.563 6.361-1.608.031-2.125-.953-3.963-.953-1.837 0-2.412.923-3.932.983-2.572.099-6.542-5.827-6.542-10.995 0-4.747 3.308-7.1 6.198-7.143 1.55-.028 3.014 1.045 3.959 1.045.949 0 2.727-1.29 4.596-1.101.782.033 2.979.315 4.389 2.377-3.741 2.442-3.158 7.549.858 9.426zm-5.222-17.607c-2.826.114-5.132 3.079-4.81 5.531 2.612.203 5.118-2.725 4.81-5.531z"/></svg>
                    App Store
                </a>
                <a href="<?php print $redirects['Android']; ?>" class="btn btn-dark">
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" clip-rule="evenodd"><path d="M1.571 23.664l10.531-10.501 3.712 3.701-12.519 6.941c-.476.264-1.059.26-1.532-.011l-.192-.13zm9.469-11.56l-10.04 10.011v-20.022l10.04 10.011zm6.274-4.137l4.905 2.719c.482.268.781.77.781 1.314s-.299 1.046-.781 1.314l-5.039 2.793-4.015-4.003 4.149-4.137zm-15.854-7.534c.09-.087.191-.163.303-.227.473-.271 1.056-.275 1.532-.011l12.653 7.015-3.846 3.835-10.642-10.612z"/></svg>                    
                    Google Play
                </a>
            </div>
